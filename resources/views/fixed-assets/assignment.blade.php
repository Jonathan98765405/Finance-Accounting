...
@section('content')
    ...
    <div class="flex items-start justify-between">
        <div class="flex gap-3">
            <a href="{{ url('/fixed-assets/edit/' . $assetData['asset_id']) }}"
            ...
            <form action="{{ url('/fixed-assets/delete/' . $assetData['asset_id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this asset? This cannot be undone.');">
                @csrf
    ...
    {{-- Row 1: Asset Info + Current Status --}}
            ...
            <div class="flex-1 grid grid-cols-2 gap-4">
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['tag'] }}</div>
                    </div>
                    <div>
                        <div class="text-xs text-gray-400">Category</div>
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['category'] }}</div>
                    </div>
                    <div>
                        <div class="text-xs text-gray-400">Serial Number</div>
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['serial_number'] }}</div>
                    </div>
                </div>
                <div class="space-y-3 pt-7">
                    <div>
                        <div class="text-xs text-gray-400">Purchase Date</div>
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['purchase_date'] }}</div>
                    </div>
                    <div>
                        <div class="text-xs text-gray-400">Purchase Cost</div>
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['purchase_cost'] }}</div>
                    </div>
                    <div>
                        <div class="text-xs text-gray-400">Warranty</div>
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['warranty'] }}</div>
                    </div>
                    <div>
                        <div class="text-xs text-gray-400">Useful Life</div>
                        <div class="text-sm font-medium text-gray-700">{{ $assetData['useful_life'] }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-5">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="font-medium text-gray-700">{{ $assetData['condition'] }}</span>
                </div>
                <div class="flex items-center justify-between">
                    <span class="text-gray-500">Location</span>
                    <span class="font-medium text-gray-700">{{ $assetData['location'] }}</span>
                </div>
                <div class="flex items-center justify-between">
    ...
    {{-- Row 2: Assignment Information + Maintenance Schedule + Maintenance History --}}
    <div class="grid grid-cols-3 gap-5">
    ...
    {{-- Row 3: Asset Timeline + Asset Document --}}
