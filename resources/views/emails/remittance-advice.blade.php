        ...
        <tr>
            <td style="padding:30px;">
                ...
                <p style="font-size:14px; line-height:1.6;">
                    Dear {{ $payment->invoice->supplier->name }},
                </p>

                <p style="font-size:14px; line-height:1.6; white-space:pre-line;">{{ $messageBody }}</p>
                ...
                <table width="100%" cellpadding="8" style="background:#f5f7fb; border-radius:10px; margin:20px 0; font-size:13px;">
                    ...
                    <tr>
                        ...
                        <td style="font-weight:700;">{{ $payment->payment_date?->format('M d, Y') }}</td>
                    </tr>
                    <tr>
                        <td style="color:#96A1B4;">Amount Paid</td>
                        <td style="font-weight:700; color:#18B876;">{{ $payment->invoice->currency }} {{ number_format((float) $payment->amount, 2) }}</td>
                    </tr>
                    <tr>
                        <td style="color:#96A1B4;">Reference No.</td>
                        <td style="font-weight:700;">{{ $payment->remittance_number }}</td>
                    </tr>
                </table>
