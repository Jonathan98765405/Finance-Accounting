...
@section('page-subtitle', 'Register a purchase order so future invoices and goods receipts can be matched against it.')
...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('ap.po.store') }}" id="poForm" class="space-y-6">
        @csrf
