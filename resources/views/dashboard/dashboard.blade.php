                ...
                @php
                    ...
                    $modules = [
                        [
                            ...
                            'value' => $ledgerEntries ?? '12,480', 'footnote' => 'Entries this month', 'href' => $moduleHref('ledger.index'),
                        ],
                        [
                            ...
                            'value' => $accountReceivable ?? '₱320,000', 'footnote' => 'Outstanding', 'href' => $moduleHref('receivable.dashboard'),
                        ],
                        [
