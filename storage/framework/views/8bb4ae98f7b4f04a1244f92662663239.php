...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title', 'Finance & Accounting'); ?></title>
        ...
        <aside
                        ...
                        <div>
                            <button type="button" data-submenu-toggle
                                class="nav-link w-full flex items-center justify-between gap-3 rounded-xl px-4 py-3 text-[15px] font-medium transition
                                                                                               <?php echo e($item['active'] ? 'active text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                                <span class="flex items-center gap-3">
                                    <i data-lucide="<?php echo e($item['icon']); ?>" class="w-5 h-5 shrink-0"></i>
                                    <span><?php echo e($item['label']); ?></span>
                                </span>
                                <span data-chevron
                                    class="shrink-0 transition-transform <?php echo e($item['active'] ? 'rotate-180' : ''); ?>">
                                    <i data-lucide="chevron-down" class="w-4 h-4"></i>
                                </span>
                            </button>

                            <div data-submenu-panel
                                class="<?php echo e($item['active'] ? '' : 'hidden'); ?> mt-1 ml-4 pl-4 border-l border-white/10 space-y-0.5">
                                <?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e($child['href']); ?>"
                                        class="flex items-center justify-between gap-2 rounded-lg px-3 py-2 text-sm transition
                                                                                                                                   <?php echo e($child['active'] ? 'text-brand-green font-semibold' : 'text-slate-300 hover:text-white'); ?>">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($item['href']); ?>"
                            class="nav-link flex items-center gap-3 rounded-xl px-4 py-3 text-[15px] font-medium transition
                                                                                           <?php echo e(!empty($item['active']) ? 'active text-white' : 'text-slate-300 hover:bg-white/5 hover:text-white'); ?>">
                            <i data-lucide="<?php echo e($item['icon']); ?>" class="w-5 h-5 shrink-0"></i>
                            <span><?php echo e($item['label']); ?></span>
                        </a>
                    <?php endif; ?>
            ...
            <button type="button" onclick="AppUI.openAccountModal()"
                ...
                <p class="account-role-name font-bold text-navy text-sm uppercase">
                    <?php echo e(session('active_role_label', 'Administrator')); ?>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-navy">
                            <?php echo $__env->yieldContent('page-title-heading', 'Dashboard'); ?></h2>
                        <p class="text-slate-500 mt-1 text-sm sm:text-base">
                            <?php echo $__env->yieldContent('page-subtitle', 'Monitor your financial performance and accounting activities in one place.'); ?>
                        </p>
                    </div>
                </div>
                        ...
                        <div id="notif-panel"
                            ...
                            <div id="notif-list" class="space-y-3 max-h-80 overflow-y-auto">
                                ...
                                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-start gap-3 <?php echo e($n['unread'] ? '' : 'opacity-60'); ?>">
                                        <div
                                            class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full <?php echo e($n['color']); ?> text-white">
                                            <i data-lucide="<?php echo e($n['icon']); ?>" class="w-4 h-4"></i>
                                        </div>
                                        <div class="flex-1">
                                            <p class="text-sm text-slate-700 leading-snug"><?php echo e($n['title']); ?></p>
                                            <p class="text-xs text-slate-400 mt-0.5"><?php echo e($n['time']); ?></p>
                                        </div>
                                        <?php if($n['unread']): ?>
    ...
    `, 'sm');
        ...
        `, 'sm');
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    fetch('<?php echo e(route("account.switch-role")); ?>', {
                        method: 'POST',
                        headers: {
                        ...
                        .then((data) => {
                            ...
                            // Automatically reload after switching
                            setTimeout(() => {
...
</html><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/layouts/app.blade.php ENDPATH**/ ?>