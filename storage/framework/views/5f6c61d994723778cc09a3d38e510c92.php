<?php $__env->startSection('page-title-heading', 'Payment Processing & GRA'); ?>
<?php $__env->startSection('page-subtitle', 'Process payments to suppliers and generate remittance advice for the payment made.'); ?>
        ...
        <div class="ap-card">
            <div class="kpi-card">
                ...
                <div>
                    ...
                    <div class="kpi-value">₱<?php echo e(number_format($totalReady, 2)); ?></div>
                    <div class="kpi-sub"><?php echo e($totalReadyCount); ?> payment(s)</div>
                </div>
            </div>
        </div>
        ...
        <div class="ap-card">
            <div class="kpi-card">
                ...
                <div>
                    ...
                    <div class="kpi-value">₱<?php echo e(number_format($processedThisMonthTotal, 2)); ?></div>
                    <div class="kpi-sub"><?php echo e($processedThisMonthCount); ?> payment(s) this month</div>
                </div>
            </div>
        </div>
        ...
        <div class="ap-card">
            <div class="kpi-card">
                ...
                <div>
                    ...
                    <div class="kpi-value">₱<?php echo e(number_format($pendingRemittanceTotal, 2)); ?></div>
                    <div class="kpi-sub"><?php echo e($pendingRemittanceCount); ?> not yet emailed</div>
                </div>
            </div>
        </div>
        ...
        <div class="ap-card">
            <div class="kpi-card">
                ...
                <div>
                    ...
                    <div class="kpi-value"><?php echo e($remittanceSentThisMonthCount); ?></div>
                ...
                <div class="p-4">
                    ...
                    <div class="table-responsive border rounded-3">
                        <table class="table align-middle mb-0" id="readyTable">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $visibleReadyPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr data-search="<?php echo e(strtolower(($payment->invoice->supplier->name ?? '') . ' ' . ($payment->invoice->invoice_number ?? ''))); ?>"
                                        data-method="<?php echo e($payment->payment_method); ?>"
                                        data-priority="<?php echo e($payment->priority); ?>">
                                        <td class="fw-semibold text-primary"><?php echo e($payment->invoice->invoice_number ?? '—'); ?></td>
                                        <td><?php echo e($payment->invoice->supplier->name ?? '—'); ?></td>
                                        ...
                                        <td><span class="priority-<?php echo e($payment->priority); ?>"><?php echo e(ucfirst($payment->priority)); ?></span></td>
                                        <td style="text-align: center;">
                                            <button type="button"
                                                    class="btn-outline-success select-payment-btn"
                                                    data-id="<?php echo e($payment->id); ?>"
                                                    data-action="<?php echo e(route('ap.payment.process', $payment)); ?>"
                                                    data-supplier="<?php echo e($payment->invoice->supplier->name ?? '—'); ?>"
                                                    data-invoice="<?php echo e($payment->invoice->invoice_number ?? '—'); ?>"
                                                    data-amount="₱<?php echo e(number_format($payment->amount, 2)); ?>"
                                                    data-method="<?php echo e($payment->payment_method); ?>">
                                                Select
                                            </button>
                                        </td>
                    ...
                    <?php if($readyPayments->count() > $readyVisibleLimit): ?>
                        <div class="view-all-wrap">
                            <button type="button" class="view-all-btn" id="openReadyViewAll">
                                View All (<?php echo e($readyPayments->count()); ?> total)
                ...
                <div class="p-4">
                    ...
                    <div class="table-responsive border rounded-3">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $visiblePaidPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="fw-semibold text-primary"><?php echo e($payment->invoice->invoice_number ?? '—'); ?></td>
                                        <td><?php echo e($payment->invoice->supplier->name ?? '—'); ?></td>
                                        ...
                                        <td>
                                            <div class="ra-link-wrapper">
                                                <a href="<?php echo e(route('ap.payment.remittance', $payment)); ?>" class="ra-link">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                                    <span><?php echo e($payment->remittance_number ?? 'Generate PDF'); ?></span>
                                                </a>
                                                <?php if($payment->remittance_sent_at): ?>
                                                    <span class="ra-sent-info">
                                                        Sent <?php echo e($payment->remittance_sent_at->diffForHumans()); ?>
                                        ...
                                        <td style="text-align: center;">
                                            <button type="button"
                                                    ...
                                                    data-action="<?php echo e(route('ap.payment.remittance.email', $payment)); ?>"
                                                    data-to="<?php echo e($payment->invoice->supplier->email ?? ''); ?>"
                                                    data-subject="Remittance Advice - Invoice <?php echo e($payment->invoice->invoice_number ?? ''); ?>"
                                                    data-message="Please find attached the remittance advice for invoice <?php echo e($payment->invoice->invoice_number ?? ''); ?>."
                    ...
                    <?php if($paidPayments->count() > $historyVisibleLimit): ?>
                        <div class="view-all-wrap">
                            <button type="button" class="view-all-btn" id="openHistoryViewAll">
                                View All (<?php echo e($paidPayments->count()); ?> total)
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg>
                            </button>
                        </div>
                    <?php endif; ?>
                ...
                <div class="p-4">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="activity-row">
                            <div class="activity-icon <?php echo e($activity->status === 'scheduled' ? 'scheduled' : 'done'); ?>">
                                <?php if($activity->type === 'remittance_sent'): ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                <?php elseif($activity->type === 'payment_scheduled'): ?>
        ...
        <div class="modal-body modal-body-scroll">
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $readyPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="fw-semibold text-primary"><?php echo e($payment->invoice->invoice_number ?? '—'); ?></td>
                                <td><?php echo e($payment->invoice->supplier->name ?? '—'); ?></td>
                                <td><?php echo e($payment->invoice->due_date?->format('M d, Y') ?? '—'); ?></td>
        ...
        <div class="modal-body modal-body-scroll">
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $paidPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="fw-semibold text-primary"><?php echo e($payment->invoice->invoice_number ?? '—'); ?></td>
                                <td><?php echo e($payment->invoice->supplier->name ?? '—'); ?></td>
                                <td><?php echo e($payment->payment_date?->format('M d, Y') ?? '—'); ?></td>
...
<?php if(session('remittance_sent')): ?>
        ...
        <div class="modal-dialog">
            <div class="modal-body p-4 text-center" style="padding: 32px; text-align: center;">
                ...
                <div class="text-start bg-light rounded-3 p-3 mb-3" style="font-size:13px; background: #f8fafc; border-radius: 8px; padding: 16px; text-align: left; margin-bottom: 24px; border: 1px solid #e2e8f0;">
                    <div style="margin-bottom:6px;"><strong>To:</strong> <?php echo e(session('remittance_sent')['to']); ?></div>
                    <div style="margin-bottom:6px;"><strong>Invoice:</strong> <?php echo e(session('remittance_sent')['invoice']); ?></div>
                    <div><strong>Attachment:</strong> <?php echo e(session('remittance_sent')['attachment']); ?></div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-payable/payment-processing.blade.php ENDPATH**/ ?>