<?php $__env->startSection('page-title', 'New Journal Entry'); ?>
<?php $__env->startSection('page-title-heading', 'New Journal Entry'); ?>
<?php $__env->startSection('page-subtitle', 'Create and record financial transactions.'); ?>
    ...
    <form action="<?php echo e(route('ledger.store')); ?>" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            <div>
                ...
                <input type="date" name="entry_date" value="<?php echo e(old('entry_date', date('Y-m-d'))); ?>"
            ...
            <div>
                ...
                <input type="text" name="reference" value="<?php echo e(old('reference')); ?>" placeholder="Example: JE-001"
                    class="w-full border border-slate-200 rounded-xl px-4 py-3" required>
            </div>
            <div>
                <label class="block text-sm font-medium mb-2">Description</label>
                <input type="text" name="description" value="<?php echo e(old('description')); ?>" placeholder="Transaction description"
                    class="w-full border border-slate-200 rounded-xl px-4 py-3" required>
            </div>
        </div>
        ...
        <div class="mt-8 flex gap-3">
            ...
            <a href="<?php echo e(route('ledger.index')); ?>" class="bg-slate-200 hover:bg-slate-300 px-6 py-3 rounded-xl">
                Cancel
            </a>
        </div>
    </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/general-ledger/create.blade.php ENDPATH**/ ?>