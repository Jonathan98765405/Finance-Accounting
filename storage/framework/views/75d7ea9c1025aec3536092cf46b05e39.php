<?php $__env->startSection('title', 'Fixed Assets'); ?>
        ...
        <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-lg border border-gray-200 p-5 flex items-center gap-4">
                <div class="w-12 h-12 rounded-full flex items-center justify-center text-white shrink-0"
                     style="background: <?php echo e($stat['color'] ?? '#22B57A'); ?>;">
                    <?php if(strtolower(trim($stat['label'] ?? '')) === 'total assets value'): ?>
                        <span class="text-lg font-bold leading-none">&#8369;</span>
                    <?php else: ?>
                        <i data-lucide="<?php echo e($resolveIcon($stat)); ?>" class="w-5 h-5"></i>
                    <?php endif; ?>
                </div>
                <div>
                    <div class="text-gray-500 text-sm"><?php echo e($stat['label']); ?></div>
                    <div class="text-xl font-bold" style="color:#173A66;"><?php echo e($stat['value']); ?></div>
                </div>
            </div>
            ...
            <ul class="space-y-3 text-xs">
                ...
                <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-start gap-2.5">
                        <span class="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5" style="background: <?php echo e($a['color']); ?>;">
                            <i data-lucide="<?php echo e($a['icon']); ?>" class="text-white" style="width:9px;height:9px;"></i>
                        </span>
                        <div class="flex-1 flex items-center justify-between gap-2">
                            <span class="text-gray-700"><?php echo e($a['text']); ?></span>
                            <span class="text-gray-400 whitespace-nowrap"><?php echo e($a['time']); ?></span>
                        </div>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-b border-gray-50 hover:bg-gray-50">
                        <td class="px-4 py-3 font-medium" style="color:#173A66;"><?php echo e($asset['id']); ?></td>
                        <td class="px-4 py-3">
                            <a href="<?php echo e(url('/fixed-assets/assignment/' . $asset['asset_id'])); ?>" class="hover:underline" style="color:#173A66;">
                                <?php echo e($asset['name']); ?>

                            </a>
                        </td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($asset['category']); ?></td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($asset['location']); ?></td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($asset['date']); ?></td>
                        <td class="px-4 py-3 text-green-600 font-medium"><?php echo e($asset['cost']); ?></td>
                        <td class="px-4 py-3">
                            <span class="px-2.5 py-1 rounded-full text-xs font-medium whitespace-nowrap" style="<?php echo e($statusColors[$asset['status']]); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/fixed-assets/index.blade.php ENDPATH**/ ?>