...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        let INCOME_BASE = <?php echo json_encode($incomeStatement, 15, 512) ?>;
        let BALANCE_BASE = <?php echo json_encode($balanceSheet, 15, 512) ?>;
      ...
      `).join('');
        ...
        async function loadYear(year) {
            ...
            const res = await fetch(`<?php echo e(url('/financial-reports/income-balance/data')); ?>?year=${year}`, {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/financial-reports/income-balance.blade.php ENDPATH**/ ?>