<?php $__env->startSection('page-title', 'Record Payment - Finance & Accounting'); ?>
<?php $__env->startSection('page-title-heading', 'Record Payment'); ?>
<?php $__env->startSection('page-subtitle', 'Accounts Receivable > Record Payment'); ?>
        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-card p-6">
                ...
                <div class="flex justify-end gap-3 mt-8 pt-4 border-t border-slate-100">
                    <a href="<?php echo e(url('/accounts-receivable')); ?>" class="px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-600 hover:bg-slate-50 transition">Cancel</a>
...
<div id="successModal" class="fixed inset-0 bg-navy/55 hidden items-center justify-center z-[100] p-4 transition-opacity">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative animate-in fade-in zoom-in duration-200">
        ...
        <div class="flex justify-center gap-3 mt-6">
            ...
            <a href="<?php echo e(url('/accounts-receivable')); ?>" class="flex-1 px-4 py-2.5 bg-navy hover:bg-navy-700 text-white rounded-xl text-sm font-semibold text-center transition">View Invoices</a>
        </div>
    </div>
</div>
...
const STORE_URL = "<?php echo e(route('receivable.storePayment')); ?>";
const CUSTOMER_INVOICES_URL_BASE = "<?php echo e(url('/accounts-receivable/customers')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-receivable/payment.blade.php ENDPATH**/ ?>