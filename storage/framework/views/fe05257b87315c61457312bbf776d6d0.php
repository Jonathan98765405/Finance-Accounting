<?php $__env->startSection('page-title', 'Accounts Receivable'); ?>
<?php $__env->startSection('page-title-heading', 'Accounts Receivable'); ?>
<?php $__env->startSection('page-subtitle', 'Manage customer invoices, track payments, and monitor outstanding balances.'); ?>

<?php $__env->startSection('content'); ?>
<!-- Action Ribbon -->
<div class="flex flex-wrap items-center justify-end gap-3 mb-6 no-print">
    <a href="javascript:void(0)" onclick="handleProtectedNavigation('<?php echo e(url('/accounts-receivable/invoice')); ?>')"
    ...
    <a href="javascript:void(0)" onclick="handleProtectedNavigation('<?php echo e(route('receivable.payment')); ?>')" 
    ...
    <div class="xl:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-card border border-slate-200 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                ...
                <a href="<?php echo e(route('receivable.allinvoices')); ?>" class="text-sm font-semibold text-navy hover:underline">View All</a>
            </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-card border border-slate-200 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
                ...
                <a href="<?php echo e(route('receivable.aging')); ?>" class="text-xs font-semibold text-navy hover:underline">View All</a>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-card border border-slate-200 p-5 no-print">
            ...
            <div class="grid grid-cols-2 gap-2 text-center text-xs font-semibold">
                ...
                <a href="javascript:void(0)" onclick="handleProtectedNavigation('<?php echo e(route('receivable.payment')); ?>')" class="flex flex-col items-center justify-center gap-1.5 bg-slate-50 border border-slate-200 hover:bg-brand-green hover:text-white hover:border-brand-green text-slate-700 p-3 rounded-xl transition group">
...
const CURRENT_DATE = new Date('<?php echo e(now()->format('Y-m-d')); ?>T00:00:00');
const customers = <?php echo json_encode($customers, 15, 512) ?>;
let invoicesData = <?php echo json_encode($invoices, 15, 512) ?>;
const outstandingData = <?php echo json_encode($outstanding, 15, 512) ?>;
const recentPaymentsData = <?php echo json_encode($recentPayments, 15, 512) ?>;
const paymentsData = <?php echo json_encode($allRecentPayments, 15, 512) ?>;

const summaryTotals = {
    totalReceivable: <?php echo e((float) $totalReceivable); ?>,
    totalPaid: <?php echo e((float) $totalPaid); ?>,
    totalUnpaid: <?php echo e((float) $totalUnpaid); ?>,
    totalPartial: <?php echo e((float) $totalPartial); ?>,
    totalOverdue: <?php echo e((float) $totalOverdue); ?>

};

const agingTotals = {
    current: <?php echo e((float) $current); ?>,
    days31_60: <?php echo e((float) $days31_60); ?>,
    days61_90: <?php echo e((float) $days61_90); ?>,
    over90: <?php echo e((float) $over90); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-receivable/dashboard.blade.php ENDPATH**/ ?>