<?php $__env->startSection('page-title', 'Review & Verify Invoice'); ?>
<?php $__env->startSection('page-title-heading', 'Review & Verify Invoice'); ?>
<?php $__env->startSection('page-subtitle', 'Review supplier invoices before approving them for Three-Way Matching.'); ?>
...
<div class="max-w-[1600px] mx-auto">
    ...
    <form method="POST" action="<?php echo e(route('ap.review.verify', $invoice)); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e($invoice->supplier->name); ?>" 
                                   readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-600 focus:outline-none" 
                                   value="<?php echo e($invoice->purchaseOrder->po_number ?? 'N/A'); ?>" 
                                   readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-600 focus:outline-none" 
                                   value="<?php echo e($invoice->invoice_date->format('F d, Y')); ?>" 
                                   readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-600 focus:outline-none" 
                                   value="<?php echo e($invoice->due_date->format('F d, Y')); ?>" 
                                   readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="₱<?php echo e(number_format($invoice->total_amount, 2)); ?>" 
                                   readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-600 focus:outline-none" 
                                   value="<?php echo e($invoice->payment_terms); ?>" 
                                   readonly>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-card border border-slate-100 p-6 sm:p-8">
                    ...
                    <textarea name="verification_remarks" 
                              ...
                              class="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-navy-600/20 text-slate-700 placeholder:text-slate-400"><?php echo e(old('verification_remarks', $invoice->verification_remarks)); ?></textarea>
                </div>

                
                <div class="flex items-center justify-end gap-3.5 pt-2">
                    <button type="submit"
                            formaction="<?php echo e(route('ap.review.reject', $invoice)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-payable/review-invoice.blade.php ENDPATH**/ ?>