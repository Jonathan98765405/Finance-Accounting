<?php $__env->startSection('page-title', 'Aging Report'); ?>
<?php $__env->startSection('page-title-heading', 'Aging Report'); ?>
<?php $__env->startSection('page-subtitle', 'Monitor outstanding receivables and analyze overdue customer balances.'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-end gap-2 sm:gap-3 no-print">
        <a href="<?php echo e(url('/accounts-receivable')); ?>"
        ...
        <a href="<?php echo e($isAdmin ? route('receivable.aging.export.pdf') : '#'); ?>"
            onclick="return verifySubmoduleAccess(event, <?php echo e($isAdmin ? 'true' : 'false'); ?>, 'Export PDF')"
        ...
        <a href="<?php echo e($isAdmin ? route('receivable.aging.export.excel') : '#'); ?>"
            onclick="return verifySubmoduleAccess(event, <?php echo e($isAdmin ? 'true' : 'false'); ?>, 'Export Excel')"
        ...
        <button onclick="if(verifySubmoduleAccess(event, <?php echo e($isAdmin ? 'true' : 'false'); ?>, 'Print Report')) window.print()"
...
<script>
    ...
    const invoicesData = <?php echo json_encode($invoicesData ?? [], 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-receivable/aging.blade.php ENDPATH**/ ?>