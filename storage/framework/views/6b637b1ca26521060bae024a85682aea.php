<?php $__env->startSection('page-title', 'Finance & Accounting | Create Invoice'); ?>
<?php $__env->startSection('page-title-heading', 'Create New Invoice'); ?>
<?php $__env->startSection('page-subtitle', 'Accounts Receivable > Create Invoice.'); ?>
...
<div class="w-full">
    ...
    <form id="invoiceForm" method="POST" action="<?php echo e(route('receivable.invoice.store')); ?>" onsubmit="return submitInvoice(event)">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex items-center justify-end mb-6">
            <div class="flex gap-3">
                <a href="<?php echo e(route('receivable.dashboard')); ?>" class="px-6 py-2.5 rounded-xl border border-slate-300 bg-white text-slate-700 font-medium hover:bg-slate-50 transition shadow-sm">Cancel</a>
                    ...
                    <div>
                        ...
                        <select id="customerSelect" name="customer_id" class="w-full border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue transition">
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($customer->id); ?>" <?php echo e(old('customer_id') == $customer->id ? 'selected' : ''); ?>><?php echo e($customer->customer_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-card p-7 border border-slate-100">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="date" id="invoiceDate" name="invoice_date" value="<?php echo e(old('invoice_date', now()->format('Y-m-d'))); ?>" class="w-full border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue transition">
                    </div>
                    <div>
                        <label class="block mb-2 font-medium text-sm text-slate-700">Due Date</label>
                        <input type="date" id="dueDate" name="due_date" value="<?php echo e(old('due_date')); ?>" class="w-full border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue transition">
                    </div>
                    <div>
                        ...
                        <select id="paymentTerms" name="payment_terms" class="w-full border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-brand-blue focus:ring-1 focus:ring-brand-blue transition">
                            ...
                            <option value="COD" <?php echo e(old('payment_terms') === 'COD' ? 'selected' : ''); ?>>COD</option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-receivable/invoice.blade.php ENDPATH**/ ?>