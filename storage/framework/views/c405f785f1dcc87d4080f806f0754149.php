<?php $__env->startSection('page-title', 'Finance & Accounting | Purchase Orders'); ?>
<?php $__env->startSection('page-title-heading', 'Purchase Orders'); ?>
<?php $__env->startSection('page-subtitle', 'Purchase orders and their goods receipt status. Both are required for a Three-Way Match.'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 no-print">
        ...
        <a href="<?php echo e(route('ap.grn.create')); ?>" 
        ...
        <a href="<?php echo e(route('ap.po.create')); ?>" 
                ...
                <tbody class="divide-y divide-slate-100 text-slate-600" id="poTableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $purchaseOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $po): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="po-row hover:bg-slate-50/50 transition cursor-pointer"
                            onclick="openPoDetails('<?php echo e($po->id); ?>')">
                            ...
                            <td class="py-4 px-6 text-slate-500">
                                <?php echo e($po->po_date->format('M d, Y')); ?>

                            </td>
                            
                            <td class="py-4 px-6 text-right font-bold text-navy">
                                ₱<?php echo e(number_format($po->total_amount, 2)); ?>
                            ...
                            <td class="py-4 px-6">
                                <?php if($po->goodsReceipts->isNotEmpty()): ?>
                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 text-brand-greenDark border border-emerald-100 text-xs font-semibold">
                                        ...
                                        <?php echo e($po->goodsReceipts->first()->grn_number); ?>
                            ...
                            <td class="py-4 px-6 text-right" onclick="event.stopPropagation()">
                                <div class="flex flex-col items-end gap-1.5">
                                    ...
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <a href="<?php echo e(route('ap.po.edit', $po)); ?>"
                                        ...
                                        <button type="button"
                                                onclick="openDeleteConfirm('<?php echo e(route('ap.po.destroy', $po)); ?>', '<?php echo e($po->po_number); ?>')"
                                    ...
                                    <?php if($po->goodsReceipts->isEmpty()): ?>
                                        <a href="<?php echo e(route('ap.grn.create', $po)); ?>" 
...
<?php $__currentLoopData = $purchaseOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $po): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div id="poDetailsModal-<?php echo e($po->id); ?>"
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
            ...
            <div class="flex items-start justify-between px-6 py-5 border-b border-slate-100">
                <div>
                    <h3 class="text-lg font-bold text-navy"><?php echo e($po->po_number); ?></h3>
                    <p class="text-sm text-slate-500 mt-0.5"><?php echo e($po->supplier->name); ?> &middot; <?php echo e($po->po_date->format('M d, Y')); ?></p>
                </div>
                <button type="button" onclick="closePoDetails('<?php echo e($po->id); ?>')"
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                    <div>
                        ...
                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold capitalize
                            <?php echo e($po->status === 'received' ? 'bg-emerald-50 text-brand-greenDark border border-emerald-100' : 'bg-slate-100 text-slate-500 border border-slate-200/60'); ?>">
                            <?php echo e($po->status); ?>
                    ...
                    <div class="col-span-2 sm:col-span-2 sm:text-right">
                        ...
                        <div class="text-lg font-bold text-navy">₱<?php echo e(number_format($po->total_amount, 2)); ?></div>
                    </div>
                </div>
                    ...
                    <table class="w-full text-left text-sm border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = ($po->items ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-2.5 px-4 text-slate-700"><?php echo e($item->description ?? '—'); ?></td>
                                    <td class="py-2.5 px-4 text-right text-slate-600"><?php echo e($item->quantity ?? '—'); ?></td>
                                    <td class="py-2.5 px-4 text-right text-slate-600">₱<?php echo e(number_format($item->unit_price ?? 0, 2)); ?></td>
                                    <td class="py-2.5 px-4 text-right font-semibold text-navy">₱<?php echo e(number_format(($item->quantity ?? 0) * ($item->unit_price ?? 0), 2)); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
...
<?php if(!\App\Models\Role::activeRoleCanManageAP()): ?>
<script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Finance-Accounting\resources\views/accounts-payable/purchase-orders.blade.php ENDPATH**/ ?>